...
| `fetch_url` | Fetch one or more pages, PDFs, images, and Reddit posts |
...
- Reddit post support uses Reddit's RSS feed, so it may return fewer comments than the full website.
